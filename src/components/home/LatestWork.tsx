  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col px-2 py-8 md:py-12 md:pl-8 md:pr-12">
        ...
        <p className="mt-6 max-w-xl font-body text-[0.9375rem] leading-relaxed text-white/45 md:mt-7 md:text-base">
          {work.description}
        </p>
        <div className="mt-auto flex gap-14 pt-10 font-mono text-[0.6875rem] uppercase tracking-[0.15em]">
          <div>
      ...
      <motion.div style={{ x, y }} className="pointer-events-none absolute left-0 top-0 z-20">
        <span className="flex -translate-x-1/2 -translate-y-1/2 items-center gap-2.5 whitespace-nowrap rounded-xl bg-[#2a2a2a]/95 px-5 py-3 font-mono text-[0.75rem] font-medium uppercase tracking-[0.12em] text-white opacity-0 shadow-xl backdrop-blur-sm transition-opacity duration-200 group-hover:opacity-100">
          See the project
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
